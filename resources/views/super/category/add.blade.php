...
<div class="card border-0 shadow-sm">
  <div class="card-body">
    ...
    <form action="{{ route('super.category.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row g-3">
        <div class="col-md-6">
          <label class="form-label">Category Title</label>
          <input type="text" name="cat_title" class="form-control" value="{{ old('cat_title') }}" required>
          @error('cat_title')
