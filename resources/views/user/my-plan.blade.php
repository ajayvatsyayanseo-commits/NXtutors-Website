...
@media(max-width:480px){
    ...
    <section class="my-plan-section">
        <div class="my-plan-wrap">
            ...
            <div class="plan-hero">
                <h1>My Student Plan</h1>
                <p>Manage your tutor contacts, AI credits, saved tutors and learning support.</p>
            </div>
            ...
            @else
                <div class="no-plan">
                    You do not have an active student plan. Choose a plan to unlock tutor contacts and AI support.
                </div>
            @endif

            <h2 class="available-title">Available Student Plans</h2>
                ...
                @foreach($studentPlans as $plan)
                    ...
                    <div class="plan-card">
                        ...
                        <ul>
                            ...
                            <li>✔ Tutor Contacts: {{ $plan->contact_limit ?? 0 }}</li>
